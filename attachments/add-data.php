...
<!-- common for all the lrs of a vechile starts here -->                    
            ...
            <div class="form-group">
                     ...
                     <div class="col-md-2" style="width:12%">
                        ...
                        <input type="text" class="form-control vechilenumber" id="Vehicle_No" name="Vehicle_No" placeholder="Number"/>
                      </div>
                      ...
                      <div class="col-md-2">
                       <label for="Driver_Name">Driver<span class="required">*</span></label>
                        <input type="text" class="form-control driver" id="Driver_Name" name="Driver_Name" placeholder="Driver Name" value="" />
                      </div>
                   
                    <div class="col-md-2">
                        <label for="FromPlace">From Place<span class="required">*</span></label>
                        <select class="form-control " id="FromPlace" name="FromPlace">
                        	<option value="select">Select From Place</option>
                       ...
                       <div class="col-md-2">
                        ...
                        <select class="form-control <?PHP echo @$ToPlacerequired; ?>" id="ToPlace" name="ToPlace">
                        	...
                        	<option value="select">Select To Place</option>
                            <option value="Hyd">Hyderabad</option>
                            <option value="Sec">Secunderabad</option>
                            <option value="Vkb">Vikarabad</option>
...
<!-- common for all the lrs of a vechile ends here -->          
            ...
            <div class=" col-md-12 col-sm-12">
           	...
           	<div class="col-sm-12">
                    <button type="button" class="btn btn-primary savelrno_btn">Save LRNO</button>
